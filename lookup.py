            ...
            if 'type' in element:
                for t in element['type']:
                    if t != 'http://www.w3.org/2002/07/owl#Thing':
                        if t.startswith('https://dbpedia.org/page/') or t.startswith('http://dbpedia.org/ontology/') or t.startswith('http://www.wikidata.org/entity/') or t.startswith('http://schema.org/'): 
                            types.add(t)
